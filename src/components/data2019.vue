    ...
    <div class="container-flex" tabindex="0" hidefocus="true">
      ...
      <div class="box-left">
        <div class="left-top" style="">
          <div id="left">
            ...
            <div class="one">
              {{ nummer }}
              <div style="color: #fff; font-size: 13px">次</div>
            </div>
          </div>
          <div id="right">
          ...
          <div id="left1">
            ...
            <div class="three">
              {{ nummer2 }}
              <div style="color: #fff; font-size: 13px">所</div>
            </div>
          </div>
          <div id="right1">
            ...
            <div class="four">
              {{ nummer3 }}
              <div style="color: #fff; font-size: 13px">种</div>
            </div>
          </div>
        </div>
        <div class="left-center">
          <iframe
            src="./static/AllData/2019年度参赛榜.html"
            frameborder="0"
            scrolling="no"
        ...
        <div class="left-bottom">
          <iframe
            src="./static/AllData/2019获奖排行榜.html"
            frameborder="0"
            scrolling="no"
            style="width: 100%; height: 100%"
          ></iframe>
      ...
      <div class="box-center">
          ...
          <div class="rootBar">
            <div class="childrenBar">
              <el-row>
                ...
                <el-button type="primary" style="background-color: #f78989"
                  >2019</el-button
                >
        ...
        <div class="center-bottom" style="overflow: auto">
          <iframe
            src="./static/AllData/anhui.html"
            style="width: 100%; height: 100%; overflow: auto"
          ></iframe>
        </div>
        <div class="center-bottom1">
          <iframe
            src="./static/AllData/2019获奖数获奖率.html"
            frameborder="0"
            scrolling="no"
            style="width: 100%; height: 100%"
          ></iframe>
      ...
      <div class="box-right">
        <div class="right-top">
          <iframe
            src="./static/AllData/moonth 2019.html"
            frameborder="0"
            scrolling="no"
            style="width: 100%; height: 100%"
          ></iframe>
