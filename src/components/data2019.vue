<template >
  ...
  <div id="page">
   ...
   <router-view></router-view>
    ...
    <pageleft style="float:left"></pageleft>
       <div class="box-left">
            <div class="left-top"style="">
                <div id="left">
                <p style="color:#fff;font-size:15px">参赛人数</p>
                <div class="one">{{nummer}}<div style="color:#fff;font-size:13px"> 次</div></div>
                </div>
                <div id="right">
               <p style="color:#fff;font-size:15px">获奖人数</p>
               <div class="two">{{nummer1}}<div style="color:#fff;font-size:13px"> 次</div></div>
                </div>
                <div id="left1">
                <p style="color:#fff;font-size:15px">覆盖高校</p>
                <div class="three">{{nummer2}}<div style="color:#fff;font-size:13px"> 所</div></div>
                </div>
                <div id="right1">
               <p style="color:#fff;font-size:15px">赛事种类</p>
                <div class="four">{{nummer3}}<div style="color:#fff;font-size:13px"> 种</div></div>
                </div>
            </div>
            <div class="left-center">
            
             <iframe src="./static/AllData/2019年度参赛榜.html"frameborder="0" scrolling="no"style="width:100%;height:100%;"></iframe>
            </div>
            <div class="left-bottom" >
            
              <iframe src="./static/AllData/2019获奖排行榜.html"frameborder="0" scrolling="no"style="width:100%;height:100%;"></iframe>
            </div>
        </div>
  ...
  <el-button type="danger"@click="data2020()">2020</el-button>
            ...
            <div class="center-bottom"style="overflow:auto;">    
             ...
             <iframe src="./static/AllData/anhui.html" style="width:100%;height:100%;overflow:auto;"></iframe>
            </div>
            <div class="center-bottom1">
           
           <iframe src="./static/AllData/2019获奖数获奖率.html"frameborder="0" scrolling="no"style="width:100%;height:100%;"></iframe>
             </div>
        ...
        <div class="box-right">
            ...
            <div class="right-top">
           <iframe src="./static/AllData/moonth 2019.html"frameborder="0" scrolling="no"style="width:100%;height:100%;"></iframe>
            </div>
            
            
     <div class="right-bottom">
            <div class="heading"style="text-align:center;height:10%">参赛热度高校排行榜</div>
            ...
            <table class="tab"style="color:#fff;margin:auto;width:95%;border-collapse:separate; border-spacing:0px 10px;">
               <thead>
                    <tr style="font-size:10px;text-align: center;">
                        <th>排名</th>
                        <th style="font-size:10px;text-align: center;">高校名称</th>
                        <th>队伍数</th>
                    </tr>
                </thead>
                <tbody>
